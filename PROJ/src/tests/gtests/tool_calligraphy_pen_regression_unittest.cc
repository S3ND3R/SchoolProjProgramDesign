...
class ToolCalligraphyPenRegressionTest : public ::testing::Test {
  void SetUp() override {
    tool_name_ = ToolCalligraphyPen::name();
 ...
 protected:
  ...
  std::string expect_file = "./resources/calligraphy_pen_expected.png";
  std::string generated_file = "./resources/calligraphy_pen_generated.png";
...
TEST_F(ToolCalligraphyPenRegressionTest, ImageRegressionEquality) {
