...
class ToolChalkRegressionTest : public ::testing::Test {
 ...
 protected:
  ...
  std::string expect_file = "./resources/chalk_expected.png";
  std::string generated_file = "./resources/chalk_generated.png";
