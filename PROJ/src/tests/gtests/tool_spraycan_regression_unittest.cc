...
class ToolSprayCanRegressionTest : public ::testing::Test {
 ...
 protected:
  ...
  std::string expect_file = "./resources/spraycan_expected.png";
  std::string generated_file = "./resources/spraycan_generated.png";
...
TEST_F(ToolSprayCanRegressionTest, ImageRegressionEquality) {
