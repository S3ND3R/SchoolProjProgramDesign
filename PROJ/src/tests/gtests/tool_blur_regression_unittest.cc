...
class ToolBlurRegressionTest : public ::testing::Test {
 ...
 protected:
  ...
  std::string expect_file = "./resources/tool_blur_expected.png";
  std::string generated_file = "./resources/tool_blur_generated.png";
...
TEST_F(ToolBlurRegressionTest, ImageRegressionEquality) {
