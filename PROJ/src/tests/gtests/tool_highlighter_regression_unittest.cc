...
class ToolHighlighterRegressionTest : public ::testing::Test {
  void SetUp() override {
    tool_name_ = ToolHighlighter::name();
 ...
 protected:
  ...
  std::string expect_file = "./resources/highlighter_expected.png";
  std::string generated_file = "./resources/highlighter_generated.png";
...
TEST_F(ToolHighlighterRegressionTest, ImageRegressionEquality) {
