...
class ToolErasureRegressionTest : public ::testing::Test {
  void SetUp() override {
    tool_name_ = ToolEraser::name();
 ...
 protected:
  ...
  std::string expect_file = "./resources/eraser_expected.png";
  std::string generated_file = "./resources/eraser_generated.png";
...
TEST_F(ToolErasureRegressionTest, ImageRegressionEquality) {
