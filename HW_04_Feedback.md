...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.GetDate.
      TA!!! make sure the test DateTest.GetDate is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.PrintUsDateWithoutNewline.
      TA!!! make sure the test DateTest.PrintUsDateWithoutNewline is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.Date.
      TA!!! make sure the test DateTest.Date is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.operatorAddition.
      TA!!! make sure the test DateTest.operatorAddition is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.operatorSubtract.
      TA!!! make sure the test DateTest.operatorSubtract is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.OverloadedSubtractCheck.
      TA!!! make sure the test DateTest.OverloadedSubtractCheck is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.OverloadedAdditionCheck.
      TA!!! make sure the test DateTest.OverloadedAdditionCheck is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.DefaultConstructorCurrentDate.
      TA!!! make sure the test DateTest.DefaultConstructorCurrentDate is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.InitializedDateProperlyEpoch.
      TA!!! make sure the test DateTest.InitializedDateProperlyEpoch is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.GetDateFunctionCorrectOrNah.
      TA!!! make sure the test DateTest.GetDateFunctionCorrectOrNah is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.LeapYearChecking.
      TA!!! make sure the test DateTest.LeapYearChecking is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.OpSubtractTests.
      TA!!! make sure the test DateTest.OpSubtractTests is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.OpAddTests.
      TA!!! make sure the test DateTest.OpAddTests is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.CurrentDateConstructorTests.
      TA!!! make sure the test DateTest.CurrentDateConstructorTests is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.OperatorsTest.
      TA!!! make sure the test DateTest.OperatorsTest is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.ConstructorsTest.
      TA!!! make sure the test DateTest.ConstructorsTest is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.AddingDays.
      TA!!! make sure the test DateTest.AddingDays is defined in the test code.
...
+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.VoidConstructor.
      TA!!! make sure the test DateTest.VoidConstructor is defined in the test code.



+ Fail: Check that a GoogleTest test passes.
    fails to run the test: DateTest.SubbingDays.
      TA!!! make sure the test DateTest.SubbingDays is defined in the test code.
