...
<pre>main.cpp:10:  At least two spaces is best between code and comments  [whitespace/comments] [2]
main.cpp:10:  Should have a space between // and comment  [whitespace/comments] [4]
main.cpp:10:  Found C system header after C++ system header. Should be: main.h, c system, c++ system, other.  [build/include_order] [4]
main.cpp:12:  Include the directory when naming .h files  [build/include] [4]
main.cpp:15:  Line ends in whitespace.  Consider deleting these extra spaces.  [whitespace/end_of_line] [4]
main.cpp:15:  Redundant blank line at the start of a code block should be deleted.  [whitespace/blank_line] [2]
main.cpp:21:  Line ends in whitespace.  Consider deleting these extra spaces.  [whitespace/end_of_line] [4]
main.cpp:23:  Line ends in whitespace.  Consider deleting these extra spaces.  [whitespace/end_of_line] [4]
main.cpp:26:  Lines should be <= 80 characters long  [whitespace/line_length] [2]
...
date.cc:115:  Never use sprintf. Use snprintf instead.  [runtime/printf] [5]
date.cc:119:  Never use sprintf. Use snprintf instead.  [runtime/printf] [5]
date.cc:123:  Never use sprintf. Use snprintf instead.  [runtime/printf] [5]
date.cc:159:  Weird number of spaces at line-start.  Are you using a 2-space indent?  [whitespace/indent] [3]
date.cc:159:  Line ends in whitespace.  Consider deleting these extra spaces.  [whitespace/end_of_line] [4]
date.cc:160:  Missing space before {  [whitespace/braces] [5]
date.cc:162:  Extra space after (  [whitespace/parens] [2]
date.cc:162:  Extra space before )  [whitespace/parens] [2]
date.cc:163:  Extra space after (  [whitespace/parens] [2]
date.cc:163:  Extra space before )  [whitespace/parens] [2]
date.cc:167:  Missing space before {  [whitespace/braces] [5]
...
date.cc:177:  Extra space after (  [whitespace/parens] [2]
date.cc:177:  Extra space before )  [whitespace/parens] [2]
